<template>
  <b-card no-body>
    ...
    >
      ...
      <template #cell(PRN,DSP,INV,DEL,CNF)="data">
        ...
        <span v-if="data.item.PRN == 'Y'" style="margin-left: -12px">
          <span
            data-v-9a6e255c=""
            class="b-avatar light_green rounded-circle"
            style="width: 32px; height: 32px"
            id="invoice-row-5036"
          >
            <span class="b-avatar-custom">
        ...
        <span
          v-if="
            data.item.PRN == undefined ||
            data.item.PRN == '' ||
            data.item.PRN == null ||
            data.item.PRN == 0 ||
            data.item.PRN == 'unknown'
          "
          style="margin-left: -12px"
        >
          <span
            data-v-9a6e255c=""
            class="b-avatar Light_blue rounded-circle"
            style="width: 32px; height: 32px"
            id="invoice-row-5027"
          >
            <span class="b-avatar-custom">
        ...
        <span
          v-if="
            data.item.DSP == undefined ||
            data.item.DSP == '' ||
            data.item.DSP == null ||
            data.item.DSP == 0 ||
            data.item.DSP == 'unknown'
          "
          style="margin-left: -12px"
        >
          <span
        ...
        <span v-if="data.item.DSP == 'ZQ'">
          <span
            data-v-9a6e255c=""
            class="b-avatar dark_green rounded-circle"
            style="width: 32px; height: 32px"
            id="invoice-row-5036"
          >
            <span class="b-avatar-custom">
        ...
        <span v-if="data.item.DSP == 'TM'">
          <span
            data-v-9a6e255c=""
            class="b-avatar orange_color rounded-circle"
            style="width: 32px; height: 32px"
            id="invoice-row-5036"
          >
            <span class="b-avatar-custom">
        ...
        <span
          v-if="
            data.item.INV == undefined ||
            data.item.INV == '' ||
            data.item.INV == null ||
            data.item.INV == 0 ||
            data.item.INV == 'unknown'
          "
          style="margin-left: -12px"
        >
          <span
        ...
        <span
          v-if="
            data.item.DEL == undefined ||
            data.item.DEL == '' ||
            data.item.DEL == null ||
            data.item.DEL == 0 ||
            data.item.DEL == 'unknown'
          "
          style="margin-left: -12px"
        >
          <span
      ...
      <!-- <template #cell(CNF)="data"> -->

      <!-- <span v-if="(data.item.CNF == 'R')" style="margin-left: -12px;">
                    <span 
                        data-v-9a6e255c="" 
                        class="b-avatar badge-light-warning rounded-circle" 
                        style="width: 32px; height: 32px; " 
                ...
                <span v-if="(data.item.CNF == 'N')" style="margin-left: -12px;">
                    <span 
                        data-v-9a6e255c="" 
                        class="b-avatar badge-light-secondary rounded-circle" 
                        style="width: 32px; height: 32px;" 
                ...
                <span v-if="(data.item.CNF == 'Y')" style="margin-left: -12px;">
                    <span
                        data-v-9a6e255c="" 
                        class="b-avatar light_green rounded-circle" 
                        style="width: 32px; height: 32px;" 
                ...
                <span v-if="(data.item.PRN == undefined || 
                data.item.PRN == '' || 
                data.item.PRN == null || 
                data.item.PRN == 0 ||
                data.item.PRN == 'unknown')" style="margin-left: -12px;">
                    <span 
                        data-v-9a6e255c="" 
                        class="b-avatar Light_blue rounded-circle" 
                        style="width: 32px; height: 32px; " 
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns: [
        ...
        { key: "webOrder", label: i18n.t("webOrder"), sortable: true },
  ...
  methods: {
    getorderdata() {
      ...
      axios(
        "https://engine.netsupport.dk:8270/orders/v1/headers/" +
          this.mytoken +
          "?offset=" +
          this.filteroffset +
          "&pagesize=" +
    ...
    multipleAction(event) {
      ...
      if (this.actionData.length == 0) {
        ...
        var config = {
          method: "put",
          url:
            "https://engine.netsupport.dk:8270/orders/v1/actions/" +
            this.mytoken,
          headers: {
